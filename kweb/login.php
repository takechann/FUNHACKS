    ...
    <!-- Portfolio Grid Section -->
            ...
            <div class="row">
             ...
             <div class="form-group">
              ...
              <div class="col-xs-10">
                <input type="text" class="form-control" name="lastname" placeholder="IDを入力してください">
              </div>
              <label class="col-xs-2 control-label">PASS</label>
              <div class="col-xs-10">
                <input type="text" class="form-control" name="lastname" placeholder="パスワードを入力してください">
              </div>
              <div>
                 <input type="button" class="btn btn-success  btn-block" value="Login" onClick="location.href='index.php'">
              </div>
              <img src="img/portfolio/margin.png" class="img-responsive" alt="" width="75" height="75">
            </div>
